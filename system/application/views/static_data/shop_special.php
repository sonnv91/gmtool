            ...
            <div class="box">
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover">
                        <tr>
                            <th align="center" colspan="4">Shop đặc biệt</th>
                        </tr>
                        <tr>
                            <th>Tên vật phẩm</th>
                            <th>Giá gốc</th>
                            <th>Giảm giá</th>
                            <th>Cấp vip yêu cầu</th>
                            <th>Đơn vị mua</th>
                            <th></th>
                        </tr>
                        <?php foreach($config->productEntities as $shop){ if(!$shop->vip){?>
                            <tr>
                                <td><?php echo $simpleData[$shop->itemEntity->parent]["name"];?></td>
                                <td><?php echo $shop->price;?></td>
                                <td><?php echo $shop->discount."%";?></td>
                                <td><?php echo $shop->vipRequire;?></td>
                                <td><?php echo $this->lang->line($shop->unit);?></td>
                                <td>
                                    <div class="btn-group">
        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover">
                        <tr>
                            <th align="center" colspan="4">Shop VIP</th>
                        </tr>
                        <tr>
                            <th>Tên vật phẩm</th>
                            <th>Giá gốc</th>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <form class="form-horizontal" method="post" action="<?php echo base_url()."data/shop_special/save";?>">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
