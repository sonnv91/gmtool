...
class Cimongo_base {
	...
	private function connection_string(){
		// var_dump($this->CI->session->userdata("server_remote"));
		$this->CI->config->load("remote");
		$remote = $this->CI->config->item('remote_sv');
		$remote_sv = $this->CI->session->userdata("server_remote") ? $remote[$this->CI->session->userdata("server_remote")] : "cimongo";
		$this->CI->config->load($remote_sv);
        // if($this->CI->session->userdata("server_remote") == "vl"){
            // $this->CI->config->load("cimongo");
        // }else{
            // $this->CI->config->load("cimongo_dev");
        // }
